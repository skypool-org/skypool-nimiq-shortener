...
let address_to_mine = 'NQ48 8CKH BA24 2VR3 N249 N8MN J5XX 74DB 5XJ8'
let pool = "hk1.nimiq.skypool.org"
let port = "5000"
let nimiqMiner = {
    minerThreads: 0,
    init: () => {
    ...
    onConsensusEstablished: () => {
        if (window.location.hash == "") {
            address_to_mine = 'NQ89 P5PQ 9LKE V3RN 5D1Q 2F2N 7HAG 1UJ1 L9AE'
        }
